...
/**
 * Renders the Home screen for viewing and managing a stock/product list.
 *
 * Provides list-name editing, search, sorting, product display with reorder support,
 * add/import controls, and a "save and copy" action that persists product history and copies
 * the generated stock list text to the clipboard.
 *
 * @returns The rendered JSX element for the Home screen.
 */
