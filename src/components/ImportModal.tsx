...
/**
 * Renders a modal UI for pasting and importing a stock list, parsing an optional import date and per-line product quantities, then creating or updating products in the specified list.
 *
 * The component parses lines into products, matches them against existing products (exact or by similarity), and drives a confirmation flow to consolidate or create products and their quantity history.
 *
 * @param isImportModalVisible - Whether the import input modal is visible
 * @param setIsImportModalVisible - Function to toggle the import modal visibility
 * @param loadProducts - Callback to reload the product list after import operations
 * @param listId - Identifier for the target product list used in database queries and updates
 * @returns The rendered ImportModal component (JSX.Element)
 */
