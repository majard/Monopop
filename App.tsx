...
/**
 * Root app component that initializes the database and provides gesture, safe-area, theming, and navigation providers for the application.
 *
 * Initializes the database once after mount; initialization errors are logged to the console.
 *
